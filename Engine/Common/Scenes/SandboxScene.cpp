...
void SandboxScene::Construct() {
    ...
    cubemap = mGenericMaterialFactory.Create<Cubemap>("Skybox Cubemap");

    //
    // Make Materials
    //
    mMaterialUnlitFactory.Make();
    mMaterialPBRFactory.Make();
    mGenericMaterialFactory.Make();

    //
    // Bind Materials
    //
    unlitRenderPipeline->Create(mMaterialUnlitFactory.GetDescriptorLayouts());
    lineRendererPipeline->Create(mMaterialUnlitFactory.GetDescriptorLayouts());
    pbrRenderPipeline->Create(mMaterialPBRFactory.GetDescriptorLayouts());
    wireframeRenderPipeline->Create(mMaterialUnlitFactory.GetDescriptorLayouts());
    ...
    monkey = CreateObject("Monkey",
                         ...
                         *wireframeRenderPipeline->m_graphicsPipeline,
                         glm::vec3(2, 0, -5),
                         glm::vec3(0),
                         glm::vec3(1.f));
    ...
    teapot = CreateObject("Teapot",
                         ...
                         *pbrRenderPipeline->m_graphicsPipeline,
                         glm::vec3(2, 0, -20),
                         glm::vec3(0),
                         glm::vec3(0.1f));
    ...
    light = CreateObject("Light",
                        ...
                        *unlitRenderPipeline->m_graphicsPipeline,
                        glm::vec3(0, 0, 0),
                        glm::vec3(0),
                        glm::vec3(0.2));
    ...
    floor = CreateObject("Floor", "/Assets/Models/cube.obj",
                        *cubeMaterial, *pbrRenderPipeline->m_graphicsPipeline,
    ...
    lineRenderer->BindRenderer(*lineRendererPipeline->m_graphicsPipeline);
...
void SandboxScene::Cleanup() {
    ...
    mMaterialUnlitFactory.Destroy();
    mMaterialPBRFactory.Destroy();
    mGenericMaterialFactory.Destroy();
    Scene::Cleanup();
}
